...
public class AB1Fragment extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_a_b1, container, false);
        listView = v.findViewById(R.id.listViewAB1);
    ...
    private void loadDataInListview() {
        ...
        questionRef.whereEqualTo("bloodGrp", "AB+").get()
            .addOnSuccessListener(queryDocumentSnapshots -> {
                if (!queryDocumentSnapshots.isEmpty()) {
                    ...
                    FragmentAdapter adapter1 = new FragmentAdapter(AB1Fragment.this, fragmentModalArrayList);
