...
public class AB2Fragment extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_a_b2, container, false);
        listView = v.findViewById(R.id.listViewAB2);
        ...
        questionRef.whereEqualTo("bloodGrp", "AB-").get()
            .addOnSuccessListener(queryDocumentSnapshots -> {
                if (!queryDocumentSnapshots.isEmpty()) {
                    ...
                    FragmentAdapter adapter1 = new FragmentAdapter(AB2Fragment.this, fragmentModalArrayList);
